...
@ManagedBean(name = "reportListTransfertMatriculeDatdebDatFinController")
@ViewScoped
public class ReportListTransfertMatriculeDatdebDatFinController extends AbstractReportBean implements Serializable{
	...
	public void edit() {
		...
		reportPdfFileUrl = super.prepareReport("ListeTransfertsMatricules", params);
