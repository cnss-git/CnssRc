...
@ManagedBean(name = "reportSalairesEstimatifsDeclaresController")
@ViewScoped
public class ReportSalairesEstimatifsDeclaresController extends AbstractReportBean implements Serializable{
	...
	public void edit() {
		...
		reportPdfFileUrl = super.prepareReport("SalairesEstimatifDeclares", params);
